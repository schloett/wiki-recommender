require(['c4/searchBar/searchBar', 'c4/APIconnector', 'util', 'c4/iframes', 'up/constants','util/browser_specific'], function (searchBar, api, util, iframes, up_constants, browserAction) {
    var logLevel = up_constants.STORAGE_PREFIX + up_constants.LOGGING_LEVEL;




    browserAction.clickedListener(function(tab) {
        browserAction.getBadgeText({}, function(badgeText) {
            if (badgeText === '') {
